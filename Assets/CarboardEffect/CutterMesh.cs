...
public class CutterMesh : MonoBehaviour
{
    ...
    {
        MeshConnectedComponents component_prediction =
            ComputeConnectedComponentsAfterCut(mesh, cutting_point, cutting_normal);
        ...
        for (int i = 0; i < mesh.triangles.Length; i += 3)
        {
            ...
            Vector3 intersection1 =
                compute_intersection(corners[one_side_index], corners[one_side_index + 2 % 3], cutting_normal);
            Vector3 intersection2 =
                compute_intersection(corners[one_side_index], corners[one_side_index + 1 % 3], cutting_normal);
